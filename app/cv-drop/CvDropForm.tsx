  ...
  if (done) {
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mb-2">¡CV recibido!</h2>
        <p className="text-slate-500 mb-6">
          Guardamos tu información. Nos pondremos en contacto cuando surja una oportunidad acorde a tu perfil.
        </p>
        <Link
          href="/jobs"
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-semibold text-slate-600 mb-1">Años de experiencia</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-slate-600 mb-1">Nivel de estudios</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-slate-600 mb-1">Modalidad preferida</label>
          ...
          <div>
            <label className="block text-sm font-semibold text-slate-600 mb-1">Disponibilidad para ingresar</label>
      ...
      <div>
        ...
        <label className="block text-sm font-semibold text-slate-600 mb-1">
          ¿A qué área apuntás o qué tipo de trabajo buscás?{" "}
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-2">
        ...
        <Link
          href="/jobs"
          className="flex-1 sm:flex-none sm:px-6 border border-slate-200 text-slate-600 py-3 rounded-xl font-semibold hover:bg-slate-50 transition-colors text-center"
        >
          Volver a puestos
        </Link>
      </div>
